...
- **HTML5**: Estruturação semântica de todas as páginas (Home, Produtos e Contato).
...
Durante o desenvolvimento deste projeto, pude colocar em prática conceitos fundamentais como:
...
Desenvolvido por **Day Trevisan** 👋
- LinkedIn: [Dayane Trevisan](https://www.linkedin.com/in/dayane-trevisan/)
- GitHub: [@daytrevisan](https://github.com/daytrevisan)
